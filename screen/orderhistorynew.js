...
import { ScrollView, StyleSheet, Text, View, TouchableOpacity, ActivityIndicator, Alert, Dimensions, SafeAreaView } from 'react-native';
...
const OrderHistoryNew = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ marginTop: 10, flex: 1 }}>
            ...
            <View style={{ paddingHorizontal: 10, borderBottomWidth: 1, borderBottomColor: "#d3d3d3", flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingBottom: 10 }}>
            ...
            <View style={{ paddingHorizontal: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 10 }}>
            ...
            {loading ? (
                ...
                jobOrders.length > 0 ? <ScrollView style={{ backgroundColor: 'red', paddingHorizontal: 10 }}>
