...
const NewOrder = ({ navigation }) => {
    ...
    const [remark, setremark] = useState(`please contact:\nMobile:`);
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', marginTop: 40, marginLeft: 10, marginRight: 5, paddingBottom: 20, borderBottomWidth: 1, borderBottomColor: "#d3d3d3" }}>
                        ...
                        <View style={{ flex: 1, alignItems: 'flex-end' }}>
                            <TouchableOpacity style={[styles.item, { backgroundColor: 'navy', borderRadius: 4 }]} onPress={submit}>
                                <Text style={{ fontSize: width / 25, fontWeight: '400', color: "#FFF", marginHorizontal: 10 }}>
...
const styles = StyleSheet.create({
    ...
    item: {
        height: 40, backgroundColor: '#c8e1ff', justifyContent: 'center', alignItems: 'center', marginRight: 10
    },
    title: {
        fontWeight: '400'
    },
